...
-- Add bank_account column to deal_supplier_invoices
ALTER TABLE public.deal_supplier_invoices ADD COLUMN IF NOT EXISTS bank_account text;

-- Update sync trigger to include bank_account
...
BEGIN
  IF TG_OP = 'INSERT' THEN
    INSERT INTO public.invoices (
      ...
      variable_symbol, due_date, bank_account
    ) VALUES (
      ...
      NEW.variable_symbol, NEW.due_date, NEW.bank_account
    );
