...
const CreateContract = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Determine lead client: prefer explicit lead_client_id on deal (objednatel),
      // fallback to is_lead_traveler flag in deal_travelers
      const leadClientId = (deal as any).lead_client_id
        || travelers?.find((t: any) => t.is_lead_traveler)?.client_id;

      if (!leadClientId) {
        toast.error("Obchodní případ nemá objednatele ani hlavního cestujícího");
        setLoading(false);
        return;
      }
